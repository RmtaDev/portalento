 ...
 * 
 *  3. Llamo al servicio para obtener el listado de ese usuario. habilidadesDemandadas
 *  
 *  4. Devuelvo la lista con un 200 al formao json
 *  
 *  5. Todo tiene que ir envuelto en un try - catch. Si surge una excepción en el catch hay que devolver 500
 *  
 *  ------pasar esto a JaVA ---------
 *
 */
