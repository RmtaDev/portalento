...
/**
 * Servlet implementation class ConsultarHabiidadDemandadaIntercambio
 */
public class ConsultarHabiidadDemandadaIntercambio extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultarHabiidadDemandadaIntercambio() {
        super();
