...
/**
 * Servlet implementation class ConsultarHabiidadOfertadaIntercambio
 */
public class ConsultarHabiidadOfertadaIntercambio extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultarHabiidadOfertadaIntercambio() {
        super();
