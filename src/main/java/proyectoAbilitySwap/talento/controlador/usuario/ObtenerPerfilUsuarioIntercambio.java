...
/**
 * Servlet implementation class ObtenerPerfilUsuarioIntercambio
 */
public class ObtenerPerfilUsuarioIntercambio extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger("mylog");
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerPerfilUsuarioIntercambio() {
        super();
