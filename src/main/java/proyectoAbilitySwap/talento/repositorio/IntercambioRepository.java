...
public class IntercambioRepository {
	...
	public static final String INTERCAMBIOS_POR_USUARIO = """
			SELECT i.idintercambio,
				i.usuario_ofertada AS id_usuario_ofertada,
			  		uo.usuario AS nombre_usuario_ofertada,
			  		uo.rutafoto AS ruta_foto_ofertada,
			    	...
			    	hd.nombre AS nombre_habilidad_demandada,
			  		...
			  		ud.rutafoto AS ruta_foto_demandada,
	...
	public static final String NUMERO_INTERCAMBIOS_POR_USUARIO = "SELECT COUNT(idintercambio) AS intercambios_pendientes_por_usuario "
			+ "FROM intercambios " + "WHERE usuario_demandada = ? AND estado = 'PENDIENTE'";
	...
	public List<IntercambioJoined> consultarNumeroIntercambiosCursadosPorUsuario(int idusuario) throws SQLException {
		...
		while (rs.next()) {
			...
			String ruta_foto_ofertada = rs.getString("ruta_foto_ofertada");
			...
			String ruta_foto_demandada = rs.getString("ruta_foto_demandada");
			...
			IntercambioJoined intercambioJoined = new IntercambioJoined(idIntercambio, id_usuario_ofertada,
					nombre_usuario_ofertada, ruta_foto_ofertada, id_habilidad_demandada, nombre_habilidad_demandada,
					id_usuario_demandada, nombre_usuario_demandada, ruta_foto_demandada, id_habilidad_ofertada,
					nombre_habilidad_ofertada, estado);
