...
public class IntercambiosCursadosPorUsuarioRepository {
	...
	public List<IntercambioJoined> consultarNumeroIntercambiosCursadosPorUsuario(int idusuario) throws SQLException {
		...
		while (rs.next()) {
			...
			IntercambioJoined intercambioJoined = new IntercambioJoined(idIntercambio, id_usuario_ofertada, nombre_usuario_ofertada, ruta_foto_ofertada,
																		id_habilidad_demandada, nombre_habilidad_demandada, 
																		id_usuario_demandada, nombre_usuario_demandada,ruta_foto_demandada,
